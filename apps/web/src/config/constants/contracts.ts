...
export default {
  ...
  masterChefV1: {
    ...
    [ChainId.SEPOLIA]: '0x512b90D17254D2cE0C82f6c28A8432C2492aC3E5',
  },
  sousChef: {
    [ChainId.BSC_TESTNET]: '0xD3af5Fe61DBaF8f73149bfcFa9FB653ff096029A',
    [ChainId.BSC]: '0x6Ab8463a4185b80905E05A9ff80A2d6b714B9e95',
    [ChainId.SEPOLIA]: '0x53AB66eabA659F1f3e7aFAc538F94890f22627bC',
  },
  lotteryV2: {
  ...
  multiCall: {
    ...
    [ChainId.SEPOLIA]: '0xf81A26ae65edB8f874Da67D8C3332BD8c7d7E6b4',
  },
  pancakeProfile: {
  ...
  nftPositionManager: {
    ...
    [ChainId.SEPOLIA]: '0xf7aB9e21c48623BD6091cEA8DC2D1B8754E3aAF4',
  },
  ...
  v3Migrator: {
    ...
    [ChainId.SEPOLIA]: '0x15fa255b324B2F1995CB61c7EF2B3C36CDF2a593',
  },
  ...
  fixedStaking: {
    [ChainId.ETHEREUM]: '0x',
    [ChainId.BSC]: '0x107d8253d2C9099997d7114bD45a36501de0a031',
    [ChainId.BSC_TESTNET]: '0x',
    [ChainId.SEPOLIA]: '0xD27B8FB12AcdE166D4004b5a8D438f3dD7887e98',
  },
  veCake: {
