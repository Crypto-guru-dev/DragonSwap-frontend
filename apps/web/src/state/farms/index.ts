...
async function getNormalFarmsStakeValue(farms, account, chainId) {
  console.log("aria data getNormalFarmsStakeValue= ", farms, account, chainId)
  ...
  console.log("aria data = ", userFarmAllowances, userFarmTokenBalances, userStakedBalances, userFarmEarnings)
