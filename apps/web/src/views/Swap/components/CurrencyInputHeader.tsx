      ...
      <Flex width="100%" alignItems="center" justifyContent="space-between" flexDirection="column">
        ...
        <Flex width="100%" justifyContent="start">
          ...
          <IconButton variant="text" scale="sm">
            <InternalLink href="/swap">
              <SwapIcon color="textSubtle" width="24px" paddingTop="2px"/>
            </InternalLink>
          </IconButton>
          <IconButton variant="text" scale="sm">
            <InternalLink href="/farms">
              <FarmIcon color="textSubtle" width="24px" paddingTop="2px"/>
            </InternalLink>
          </IconButton>
          <NotificationDot show={expertMode || isRoutingSettingChange}>
            <GlobalSettings color="textSubtle" mr="0" pt="2px" mode={SettingsMode.SWAP_LIQUIDITY} />
          </NotificationDot>
          <IconButton onClick={onPresentTransactionsModal} variant="text" scale="sm">
            <HistoryIcon color="textSubtle" width="24px" paddingTop="2px"/>
          </IconButton>
