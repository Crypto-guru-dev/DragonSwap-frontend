            ...
            <Flex flexDirection="column">
              <FarmFlexWrapper justifyContent="space-between">
                <Box style={{ flex: '1 1 100%' }}>
                  <FarmH1 as="h1" scale="lg" color="secondary" mb="24px">
                    {t('Farms')}
                  </FarmH1>
                  <FarmH2 scale="sm" color="text">
                    {t('Stake LP tokens And Earn Token Rewards')}
                  </FarmH2>
