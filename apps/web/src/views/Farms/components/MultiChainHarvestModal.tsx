...
const MultiChainHarvestModal: React.FC<MultiChainHarvestModalProp> = ({
  ...
  const network = isTestnet ? ChainId.SEPOLIA : ChainId.SEPOLIA
    ...
    if (receipt?.status) {
      toastSuccess(
        ...
        <ToastDescriptionWithTx txHash={receipt.transactionHash}>
          {t('Your %symbol% earnings have been sent to your wallet!', { symbol: 'DRX' })}
            ...
            <MessageText>
              <FlexGap gap="12px">
                <FlexGap gap="6px">
                  ...
                  <ChainLogo chainId={ChainId.SEPOLIA} />
                </FlexGap>
