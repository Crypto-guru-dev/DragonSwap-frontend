...
const MultiChainHarvestModal: React.FC<MultiChainHarvestModalProp> = ({
  ...
  const network = isTestnet ? ChainId.BYTE_TESTNET : ChainId.BYTE_TESTNET
    ...
    if (receipt?.status) {
      toastSuccess(
        ...
        <ToastDescriptionWithTx txHash={receipt.transactionHash}>
          {t('Your %symbol% earnings have been sent to your wallet!', { symbol: 'JIM' })}
            ...
            <MessageText>
              <FlexGap gap="12px">
                <FlexGap gap="6px">
                  ...
                  <ChainLogo chainId={ChainId.BYTE_TESTNET} />
                </FlexGap>
