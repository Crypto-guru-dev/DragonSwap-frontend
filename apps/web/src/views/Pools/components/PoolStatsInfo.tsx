import { Flex, LinkExternal, ScanLink, Skeleton, Text, FlexLayout } from '@pancakeswap/uikit'
  ...
  return (
    <>
      ...
      <Flex mb="2px" justifyContent={alignLinksToRight ? 'flex-end' : 'flex-start'}>
        <LinkExternal href={tokenInfoPath || undefined} bold={false} small color='white'>
          {t('See Token Info')}
        </LinkExternal>
      </Flex>
      {!vaultKey && (
      ...
      {account && tokenAddress && (
        <Flex justifyContent={alignLinksToRight ? 'flex-end' : 'flex-start'}>
          <AddToWalletButton
            ...
            p="0"
            height="auto"
            style={{ fontSize: '14px', fontWeight: '400', lineHeight: 'normal', color: 'white' }}
